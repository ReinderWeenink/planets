...
docker.com account maken
maak een git met project
laatste slite
docker build locaal
docker publish
git staat altijd stnadaard op de server
install docker
image van de docker pulbliceren
hub.docker docker publish
build met amd flag
dockercompose file verwijst naar hub
git yml file make
